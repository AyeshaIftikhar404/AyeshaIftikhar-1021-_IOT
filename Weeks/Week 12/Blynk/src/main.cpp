...
#define BLYNK_TEMPLATE_ID "TMPL6PNWWa7lm"
#define BLYNK_TEMPLATE_NAME "DHT by ayesha"
#define BLYNK_AUTH_TOKEN "-4IE1RL-jPBDeNJplbSvw7zfkh1foYJj"
...
void setup() {
  ...
  Blynk.begin(BLYNK_AUTH_TOKEN, ssid, pass); //real time cloud connected to devi
